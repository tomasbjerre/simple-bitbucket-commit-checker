...
public class GroupOneRuleOneMatchingAllAcceptTest {
 ...
 public void testThatItCanAcceptACommit() throws IOException {
  refChangeBuilder().withGroupAcceptingOnlyBothJiraAndIncInEachCommit()
    .withChangeSet(changeSetBuilder().withId("1").withMessage(COMMIT_MESSAGE_JIRA_INC).build()).build().run()
 ...
 public void testThatItCanAcceptMultipleCommits() throws IOException {
  refChangeBuilder().withGroupAcceptingOnlyBothJiraAndIncInEachCommit()
    ...
    .withChangeSet(changeSetBuilder().withId("2").withMessage(COMMIT_MESSAGE_JIRA_INC + " hej").build()).build().run()
    .hasNoOutput().wasAccepted();
 }
 ...
 public void testThatItCanRejectSomeOfMultipleCommits() throws IOException {
  refChangeBuilder().withGroupAcceptingOnlyBothJiraAndIncInEachCommit()
    ...
    .withChangeSet(changeSetBuilder().withId("3").withMessage(COMMIT_MESSAGE_JIRA_INC + "2").build()).build().run()
    .hasTrimmedFlatOutput(
