...
public class GroupManyRuleManyTest {
 ...
 public void testThatACommitCanBeRejectedBySecondOfTwoGroups() throws IOException {
  refChangeBuilder()
    ...
    .run()
    .hasTrimmedFlatOutput(
      "refs/heads/master e2bc4ed003 -> af35d5c1a4   2 Tomas <my@email.com> >>> SB-5678 fixing stuff  - You need to specity INC   Incident, INC: INC   3 Tomas <my@email.com> >>> fixing stuff INC3  - You need to specity JIRA   JIRA: ((?<!([A-Z]{1,10})-?)[A-Z]+-\\d+)")
    .wasRejected();
 }
 ...
 public void testThatACommitShowMessageFromFirstOfTwoGroups() throws IOException {
  refChangeBuilder()
    ...
    .run()
    .hasTrimmedFlatOutput(
      "refs/heads/master e2bc4ed003 -> af35d5c1a4   3 Tomas <my@email.com> >>> fixing stuff INC3  - You need to specity JIRA   JIRA: ((?<!([A-Z]{1,10})-?)[A-Z]+-\\d+)  - You need to specity INC")
    .wasRejected();
 }
 ...
 public void testThatOneGroupCanAcceptAllMatchingJiraAndOneGroupRejectNoneMatchingQC() throws IOException {
  refChangeBuilder()
    ...
    .run()
    .hasTrimmedFlatOutput(
      "refs/heads/master e2bc4ed003 -> af35d5c1a4   3 Tomas <my@email.com> >>> SB-5678 fixing stuff INC3  - Dont include INC   Incident, INC: INC")
    .wasRejected();
 }
 ...
 public void testThatOneGroupCanAcceptAllMatchingJiraAndOneGroupRejectNoneMatchingQCPartly() throws IOException {
  refChangeBuilder()
    ...
    .run()
    .hasTrimmedFlatOutput(
      "refs/heads/master e2bc4ed003 -> af35d5c1a4   2 Tomas <my@email.com> >>> SB-5678 fixing stuff INC3  - Dont include INC   Incident, INC: INC   3 Tomas <my@email.com> >>> fixing stuff INC3  - You need to specity JIRA   JIRA: ((?<!([A-Z]{1,10})-?)[A-Z]+-\\d+)  - Dont include INC   Incident, INC: INC")
    .wasRejected();
 }
}
