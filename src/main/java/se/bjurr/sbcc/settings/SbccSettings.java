...
public class SbccSettings {
 ...
 public static final String SETTING_REQUIRE_MATCHING_AUTHOR_EMAIL_BITBUCKET = "requireMatchingAuthorEmailInBitbucket";
 ...
 public static final String SETTING_REQUIRE_MATCHING_AUTHOR_NAME_BITBUCKET = "requireMatchingAuthorNameInBitbucket";
 ...
 public static SbccSettings sscSettings(Settings settings) throws ValidationException {
  ...
  sbccSettings
    ...
    .withRequireMatchingAuthorEmailInBitbucket(settings.getBoolean(SETTING_REQUIRE_MATCHING_AUTHOR_EMAIL_BITBUCKET))
    ...
    .withRequireMatchingAuthorNameInBitbucket(settings.getBoolean(SETTING_REQUIRE_MATCHING_AUTHOR_NAME_BITBUCKET))
 ...
 private SbccSettings withRequireMatchingAuthorEmailInBitbucket(Boolean requireMatchingAuthorEmailInBitbucket) {
  this.requireMatchingAuthorEmailInBitbucket = firstNonNull(requireMatchingAuthorEmailInBitbucket, FALSE);
  return this;
 }
 ...
 private SbccSettings withRequireMatchingAuthorEmailMessage(String requireMatchingAuthorEmailMessage) {
 ...
 private SbccSettings withRequireMatchingAuthorNameInBitbucket(Boolean requireMatchingAuthorNameInBitbucket) {
  this.requireMatchingAuthorNameInBitbucket = firstNonNull(requireMatchingAuthorNameInBitbucket, FALSE);
  return this;
 }
 ...
 private SbccSettings withRequireMatchingAuthorNameMessage(String requireMatchingAuthorNameMessage) {
